...
<footer class="footer">
    ...
    <div class="wrapper-inside">
        <div class="footer-line-1">
            ...
            <div class="header-contacts lg-view">
        ...
        <div class="footer-line-2 xs-view">
            <div class="footer-politica">
                <a href="/confidentiality/">
                    Политика обработки персональных данных
                </a>
...
<div style="display: none;">
    ...
    <div class="popUp popUp-item" id="price-message">
        ...
        <div class="calc-btn" style="display: flex; justify-content: center;">
            <a onclick="ym(53915065,'reachGoal','price-send'); return true;" href="/img/price2023.pdf" data-fancybox="gallery-4" class="btn btn-primary">Открыть прайс</a>
        </div>
        <div class="calc-btn" style="display: flex; justify-content: center;">
...
<div class="popUp popUp-item" id="question-form">
    ...
    <div class="popUp popUp-item" id="consultation-form">
        <div class="popUp-container">
            ...
            <div class="calculator-container-desc">
                ...
                <form class="ajax-form-send price-thanks" name="form-type-application" data-formtype="form-type-application" id="applicationFormSend" action="">
                    <input type="hidden" name="form-type-application" id="form-type-application" value=""/>
                    <div class="form-item-line">
                        <div class="form-item-one width-100">
                            <label>Ваше имя</label>
                            <input maxlength="30" type="text" id="applicationUserName" name="applicationUserName" required/>
                        </div>
                    </div>
                    <div class="form-item-line">
                        <div class="form-item-one width-100">
                            <label>номер телефона</label>
                            <input class="phoneNumber" type="text" id="applicationUserPhone" name="applicationUserPhone" required/>
                        </div>
                    </div>
                    <div class="form-item-line">
                        <div class="form-item-one width-100">
                    ...
                    <div class="calc-btn">
                        <button type="submit" onclick="ym(53915065,'reachGoal','price-send'); return true;" class="btn btn-primary">Получить прайс</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="popUp popUp-item" id="application-form">
        <div class="popUp-container">
            ...
            <div class="popUp-body">
                <form class="ajax-form-send" name="form-type-circle" data-formtype="form-type-circle" id="applicationFormSend" action="">
                    <input class="form-type-circle" type="hidden" name="name-form-circle" id="name-form-circle" value=""/>
                    <div class="form-item-line">
                        <div class="form-item-one width-100">
                            <label>Ваше имя</label>
                    ...
                    <div class="calc-btn">
                        <button type="submit" onclick="ym(53915065,'reachGoal','price-send'); return true;" class="btn btn-primary">Оставить заявку</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="popUp popUp-item" id="application-form-classic">
        <div class="popUp-container">
            ...
            <div class="popUp-body">
                <form class="ajax-form-send" name="form-type-application" data-formtype="form-type-application" id="applicationFormSend" action="">
                    <input type="hidden" name="form-type-application" id="form-type-application" value=""/>
                    <div class="form-item-line">
                        <div class="form-item-one width-100">
                            <label>Ваше имя</label>
                            <input maxlength="30" type="text" name="applicationUserName" id="applicationUserName" required/>
                        </div>
                    </div>
                    <div class="form-item-line">
                        <div class="form-item-one width-100">
...
<?if($dir === "/colors/"):?>
    <script type='text/javascript' id='mfn-plugins-js-extra'>
        ...
        var mfn = {
            ...
            "slider": {"blog": 0, "clients": 0, "offer": 0, "portfolio": 0, "shop": 0, "slider": 2000, "testimonials": 0},
            "livesearch": {
                "minChar": 3,
                "loadPosts": 10,
                "translation": {
