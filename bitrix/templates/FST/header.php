...
if (isset($_GET["yclid"])) setcookie('yclid', $_GET["yclid"], time() + 3600 * 24 * 30, '/');
?>
<!DOCTYPE html>
<html lang="ru">
<head>
                    ...
                    <div class="header-email">
                        <a href="mailto:sales@fst-klinker.ru">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 18"
                                 fill="none">
                                <path d="M1 4.96377C1 4.14648 1.9272 3.67433 2.58817 4.15503L11.4118 10.5722C11.7625 10.8273 12.2375 10.8273 12.5882 10.5722L21.4118 4.15503C22.0728 3.67433 23 4.14648 23 4.96377V16C23 17.1046 22.1046 18 21 18H3C1.89543 18 1 17.1046 1 16V4.96377Z"
                                      fill="#BE6853"/>
                                <path d="M2.74807 1.83205L11.4453 7.6302C11.7812 7.85413 12.2188 7.85413 12.5547 7.6302L21.2519 1.83205C22.0752 1.28323 21.6866 0 20.6972 0H3.30278C2.31337 0 1.92484 1.28322 2.74807 1.83205Z"
                                      fill="#BE6853"/>
                            </svg>
                        </a>
                    </div>
